...
class Interactive(abc.ABC):
    ...
    def __init__(self, env, sync=True, tps=60, aspect_ratio=None):
        ...
        max_win_width = screen.width * 0.7
        max_win_height = screen.height * 0.7
    ...
    def _update(self, dt):
        ...
        while self._sim_time < self._current_time:
            ...
            if not self._sync or act is not None:
                ...
                print([int(var2) for var2 in var1], rew, obs, done, _info)
...
def main():
    ...
    # ia = RetroInteractive(game=args.game, state='GreenHillZone.Act1', scenario=args.scenario)
